...
@section('content')
    <div class="d-flex text-center justify-content-center">
        <div class="col">
            ...
            <div class="d-flex justify-content-center pt-3">
                <a class="col-sm-4 btn btn-success btn-block text-white" href="{{url('recruitment')}}">Find out how to test or develop <i class="fa fa-user"></i> <i class="fa fa-code"></i></a>
            </div>
        </div>
    </div>
@endsection